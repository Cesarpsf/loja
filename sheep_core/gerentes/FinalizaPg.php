<<?php
    ...
    class FinalizaPg
    {
                ...
                foreach ($lerCompras->getResultado() as $carrinho){
                    ...
                    if ($prod) {
                        ...
                        foreach ($lerCompras->getResultado() as $produto) {
                            ...
                            $clientId = 'Client_Id_6a64f8344072d504463dc88233a4d0023a488b6b'; // insira seu Client_Id, conforme o ambiente (Des ou Prod)
                            $clientSecret = 'Client_Secret_0c23ee6922c1479bcb0226679b7babd1d8047b83'; // insira seu Client_Secret, conforme o ambiente (Des ou Prod)
                            ...
                            $items = [
                                [
                                    "name" => 'Pedido n° ' . $criarCliente->getResultado() . date('s') . date('d') . date('Y'),
                                    "amount" => 1,
                                    "value" => intval($valor),
                                ]
                            ];
        ...
        private function AtualizaStatus()
        {
            ...
            $dadosSatus = ['status' => 'S'];
            $atualizaStatus->Atualizando('compras', $dadosSatus, "WHERE id_cliente = :id", "id={$this->Id}");
