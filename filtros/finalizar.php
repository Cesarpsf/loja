...
if (isset($clienteCadastro['Finalizar'])){
   ...
   if ($salvar->getResultado()) {
      ...
      header("Location: https://api.whatsapp.com/send?phone=5511945171485&text=Seu pedido foi recebido, confira agora o número do pedido a lista de produtos e o boleto para pagamento: ".HOME."/ver_pedido.php");
   } else {
